          ...
          foreach ($data->result as $post) {
            for ($productNum = 0; $productNum < count($post->products); $productNum++) {
              $ozonFboDataDB = [
                  ...
                  'digital_codes' => json_encode($post->products[$productNum]->digital_codes), 
                  ...
                  'marketplace_service_item_fulfillment' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_fulfillment, 
                  'marketplace_service_item_pickup' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_pickup, 
                  'marketplace_service_item_dropoff_pvz' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_dropoff_pvz, 
                  'marketplace_service_item_dropoff_sc' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_dropoff_sc, 
                  'marketplace_service_item_dropoff_ff' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_dropoff_ff, 
                  'marketplace_service_item_direct_flow_trans' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_direct_flow_trans, 
                  'marketplace_service_item_return_flow_trans' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_return_flow_trans, 
                  'marketplace_service_item_deliv_to_customer' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_deliv_to_customer, 
                  'marketplace_service_item_return_not_deliv_to_customer' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_return_not_deliv_to_customer, 
                  'marketplace_service_item_return_part_goods_customer' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_return_part_goods_customer, 
                  'marketplace_service_item_return_after_deliv_to_customer' => $post->financial_data->products[$productNum]->item_services->marketplace_service_item_return_after_deliv_to_customer, 
